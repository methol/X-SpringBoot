...
public class SysLogAspect {
    ...
    private void saveSysLog(ProceedingJoinPoint joinPoint, long time) {
        ...
        com.suke.czx.common.annotation.SysLog syslog = method.getAnnotation(
                com.suke.czx.common.annotation.SysLog.class);
        if (syslog != null) {
            //注解上的描述
        ...
        //用户名
        // String username = ((CustomUserDetailsUser) SecurityContextHolder.getContext().getAuthentication()
        // .getPrincipal()).getUsername(); 强转有问题...原因有待研究
        String userStr = objectMapper.writeValueAsString(
